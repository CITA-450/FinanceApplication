# Class Ledger
from sqlalchemy import create_engine, ForeignKey, Column, String, Integer, CHAR , DATE, Boolean
...
class Ledger(Base):
    ...
    userFiD = Column('User_ID', String,ForeignKey)
