...
--
-- Host: 127.0.0.1    Database: db_cita450
-- ------------------------------------------------------
...
CREATE TABLE `line` (
  ...
  CONSTRAINT `line_chk_2` CHECK ((`freq` >= 0))
...
INSERT INTO `line` VALUES (1,1,'2023-10-06 22:46:46',300.00,1,0,'2023-12-12',NULL,'testline');
...
-- Dump completed on 2023-10-20 17:40:25
